<div class="row page-menu-buttons">
	...
	<div class="col-sm-7 text-right">
		<a class="btn btn-primary export-data-btn" href="javascript:;" role="button" data-url="<%=ajaxurl.exportExamOrder%>">导出考试订单信息</a>
	</div>
</div>
		...
		<div class="box-body">
			<div class="form-group-line clearfix">
				<div class="form-group col-sm-12">
					...
					<div class="row input-group">
						<div class="col-sm-5">
							<input type="text" class="form-control form_datetime" id="purchaseTimeStartInput" placeholder="下单开始时间">
						</div>
						<div class="col-sm-1">至</div>
						<div class="col-sm-6">
							<input type="text" class="form-control form_datetime" id="purchaseTimeEndInput" placeholder="下单开始时间">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-group col-sm-3">
				...
				<select type="text" class="form-control status-select">
					...
					<option value="purchased">已支付</option>
					<option value="refund-applied">申请退款</option>
