						...
						<div class="col-sm-9">
							<div class="row">
								<div class="checkbox">
									<label>
										<%if(mode=='edit'){%>
											<%if(model.get('makeup_enroll_status') === 0){%>
									    	<input type="checkbox" checked="checked" id="makeup_enroll_status">
									    	<%}else{%>
									    	<input type="checkbox" id="makeup_enroll_status">
									    	<%}%>
								    	<%}else{%>
								    	<input type="checkbox" id="makeup_enroll_status" checked="checked">
								    	<%}%> 支持补报名
								    </label>
								</div>
							</div>
						...
						<div class="col-sm-9">
							<div class="row">
								<div class="checkbox">
									<label>
									<%if(mode=='edit'){%>
										<%if(model.get('apply_refund_status') === 0){%>
								    	<input type="checkbox" checked="checked" id="apply_refund_status">
								    	<%}else{%>
								    	<input type="checkbox" id="apply_refund_status">
								    	<%}%>
							    	<%}else{%>
							    	<input type="checkbox" id="apply_refund_status" checked="checked">
							    	<%}%> 支持退款
								    </label>
								</div>
							</div>
						...
						<div class="col-sm-9">
							...
							<div class="row">
								<div class="checkbox">
									<label>
										<%if(mode=='edit'){%>
											<%if(model.get('apply_paper_status') === 0){%>
									    	<input type="checkbox" checked="checked" id="apply_paper_status">
									    	<%}else{%>
									    	<input type="checkbox" id="apply_paper_status">
									    	<%}%>
								      	<%}else{%>
								      	<input type="checkbox" checked="checked" id="apply_paper_status">
								      	<%}%>
