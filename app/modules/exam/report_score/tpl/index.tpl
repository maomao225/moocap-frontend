<div class="row page-menu-buttons">
	...
	<div class="col-sm-7 text-right">
		<a class="btn btn-primary export-data-btn" href="javascript:;" role="button" data-url="<%=ajaxurl.exportUpscores%>">导出考试成绩信息</a> 
	</div>
</div>
	...
	<form class="form-inline search-form">
		<div class="box-body">
			...
			<div class="form-group col-sm-8">
				...
				<input type="text" class="form-control" id="keywordInput" placeholder="请输入考试科目\学校\学生姓名\身份证号\准考证号的关键字" style="width:400px;">
			</div>
		</div>
